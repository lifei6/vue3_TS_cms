<template>
  <div class="content">
    ...
    <div class="table">
      <el-table :data="usersList" :border="true" style="width: 100%" highlight-current-row>
    ...
    <div class="footer">
      <el-pagination v-model:currentPage="currentPage" v-model:page-size="pageSize" :page-sizes="[10, 20, 30]"
        layout="total, sizes, prev, pager, next, jumper" :total="usersTotalCount" @update:page-size="handlePageSizeChange"
...
const handleEnable = (row: any) => {
  ...
  const newData = { ...row, enable }
  console.log(newData)
  systemStore.editUserDataAction(row.id, newData)
}
